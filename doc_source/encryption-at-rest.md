...
**Note**  
Encryption at rest is not enabled by default when creating a new file system using the AWS CLI, API, and SDKs\. For more information, see [Creating a file system using the AWS CLI](creating-using-create-fs.md#creating-using-fs-part1-cli)\.
...
#### AWS managed key for Amazon EFS KMS policy<a name="efs-aws-managed-key-policy"></a>
