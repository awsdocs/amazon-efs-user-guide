...
## Recommended Amazon EFS backup solutions<a name="recommended-backup-solutions"></a>
...
**Topics**
+ [Recommended Amazon EFS backup solutions](#recommended-backup-solutions)
...
+ [Considerations for Amazon EFS backup using AWS Data Pipeline](#backup-considerations)
...
## Considerations for Amazon EFS backup using AWS Data Pipeline<a name="backup-considerations"></a>
